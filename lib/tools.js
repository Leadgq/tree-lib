...
export class Clipboard {
    ...
    /**
     * @param { string } text 
     * @description 这是新的方法、若支持则使用新的方法、否则使用execCommand
     * @description 复制文本到剪切板中
     * @description 只有dom被聚焦才能使用、input、textarea等
    */
    ...
    /**
     * @description 这是新的方法、注意兼容性
     * @returns { string } 
     * @description 读取剪切板中的文本
    */
