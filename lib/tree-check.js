...
export const cloneTree = (tree) => {
    ...
    const isSupportStructuredClone = 'structuredClone' in globalThis;
    if (isSupportStructuredClone) {
        return isAbleObject(tree) ? structuredClone([tree]) : structuredClone(tree);
    } else {
